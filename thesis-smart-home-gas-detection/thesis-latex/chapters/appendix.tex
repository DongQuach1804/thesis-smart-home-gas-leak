...
# Huấn luyện LSTM Forecaster (~5 phút)
python processing/ml/lstm/train_forecaster.py \
    --hours 4 --epochs 15

# Huấn luyện RL Controller (~10-15 phút)
...
docker compose up --build     # Build và khởi động tất cả service
\end{verbatim}

Sau khi khởi động:
\begin{itemize}
  \item Dashboard: \texttt{http://localhost:8080}
...
\texttt{SIM\_PUBLISH\_HZ}      & 1.0       & Tần suất publish cảm biến \\
\bottomrule
\end{tabular}
\end{table}
