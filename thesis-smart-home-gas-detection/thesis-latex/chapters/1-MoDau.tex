...
\begin{itemize}
  ...
  \item \textbf{Bộ điều khiển PPO} được huấn luyện trong môi trường Gymnasium tích hợp vật lý bộ mô phỏng, với hàm thưởng cân bằng giữa hiệu quả can thiệp và chi phí cảnh báo sai.
  ...
  \item \textbf{Phương pháp đánh giá hai lượt (oracle + controller)} đảm bảo so sánh công bằng giữa các bộ điều khiển.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Chương 4 – Thực nghiệm, đánh giá và thảo luận}: Trình bày kết quả huấn luyện mô hình, kết quả benchmark so sánh ba bộ điều khiển, và phân tích hệ thống trong điều kiện vận hành.
